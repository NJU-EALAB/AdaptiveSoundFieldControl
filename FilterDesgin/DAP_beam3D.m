function [ MPS, Theta, Phi, Frequency, theta_step, phi_step, p_beam1  ] = DAP_beam3D(h, h_eq)
...
N_spk = size(G0, 1);
load('D:\Documents\RoomSimulation\SourceBeamCtrl\beamformer\Data\f_1_24_oct.mat');
...
%% octave filter
load('D:\Documents\RoomSimulation\SourceBeamCtrl\beamformer\Data\f_1_3_oct_right.mat');
